...
protected override void SetupFishingFloat(Entity<FishingRodComponent> fishingRod, EntityUid player, EntityCoordinates target)
    {
        ...
        // REVERTED: This component field seems to be EntityUid, so passing fishFloat directly is correct.
        ...
        // REVERTED: This component field is likely EntityUid, so passing uid directly is correct.
        ...
        // KEPT: JointVisualsComponent is a core engine component and definitely uses NetEntity.
        // This was likely the source of your original error.
